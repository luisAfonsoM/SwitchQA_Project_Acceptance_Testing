...
const us021seed = async () => {
    const userQuery = `
    INSERT INTO base_user (base_user_id, user_email, username, user_password, created_at, updated_at) VALUES ("43934178-0dbd-49cc-b4de-ae5019d3b25f", "popularpost@dddforum.com", "PopularPost", "$2a$10$EJclxpwB4b8vO0rDn.9EMujl9tqS7ttPKkfLVfWcMLXly4ymFMwVS", "2023-12-02 16:00:00", "2023-12-02 16:00:00");    `;
    ...
    try {
      ...
      console.log('us021 test data seeded successfully.');
    } catch (error) {
      console.error('Error seeding us021 test data:', error);
    }
  };
  
  export default us021seed;